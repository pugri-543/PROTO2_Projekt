...
of the server information (player count and Server version), the dashboard will also contain an input field with the the label **Kick**, insert the username of the
...
## - 6 - DigiLab buttons used to give player  food item
